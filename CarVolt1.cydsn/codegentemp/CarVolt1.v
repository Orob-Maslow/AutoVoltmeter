// ======================================================================
// CarVolt1.v generated from TopDesign.cysch
// 03/05/2021 at 07:40
...
module ADC_SAR_SEQ_P4_v2_60_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("dcb9ad89-b0b2-4b70-8f3a-5ebaa9588505/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("dcb9ad89-b0b2-4b70-8f3a-5ebaa9588505/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Alternator_net;
	wire [0:0] tmpFB_0__Alternator_net;
	wire [0:0] tmpIO_0__Alternator_net;
	wire [0:0] tmpINTERRUPT_0__Alternator_net;
	electrical [0:0] tmpSIOVREF__Alternator_net;

	cy_psoc3_pins_v1_10
		#(.id("0d5630b8-a326-41e8-8252-dbeea4c80d3b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Alternator
		 (.oe(tmpOE__Alternator_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Alternator_net[0:0]}),
		  .analog({Net_125}),
		  .io({tmpIO_0__Alternator_net[0:0]}),
		  .siovref(tmpSIOVREF__Alternator_net),
		  .interrupt({tmpINTERRUPT_0__Alternator_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Alternator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Outside_net;
	wire [0:0] tmpFB_0__Outside_net;
	wire [0:0] tmpIO_0__Outside_net;
	wire [0:0] tmpINTERRUPT_0__Outside_net;
	electrical [0:0] tmpSIOVREF__Outside_net;

	cy_psoc3_pins_v1_10
		#(.id("2360f338-515d-4e70-b54b-3cf5af6f0a9c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Outside
		 (.oe(tmpOE__Outside_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Outside_net[0:0]}),
		  .analog({Net_151}),
		  .io({tmpIO_0__Outside_net[0:0]}),
		  .siovref(tmpSIOVREF__Outside_net),
		  .interrupt({tmpINTERRUPT_0__Outside_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Outside_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Inside_net;
	wire [0:0] tmpFB_0__Inside_net;
	wire [0:0] tmpIO_0__Inside_net;
	wire [0:0] tmpINTERRUPT_0__Inside_net;
	electrical [0:0] tmpSIOVREF__Inside_net;

	cy_psoc3_pins_v1_10
		#(.id("5051441d-6d14-40fe-87b7-14f26bdbb058"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Inside
		 (.oe(tmpOE__Inside_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Inside_net[0:0]}),
		  .analog({Net_176}),
		  .io({tmpIO_0__Inside_net[0:0]}),
		  .siovref(tmpSIOVREF__Inside_net),
		  .interrupt({tmpINTERRUPT_0__Inside_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Inside_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("177f31d6-96de-4c5b-a3ad-f060f41968fc"),
